...
const MONGO_URI =
  process.env.MONGODB_URI ?? "mongodb://localhost:27017/fmnexus";
...
async function seed() {
  ...
  const assets = await Asset.insertMany([
    ...
    },
    {
      ...
      value: 35000,
      warrantyExpiry: new Date("2021-11-05"),
  ...
  const vendors = await Vendor.insertMany([
    ...
    },
    {
      ...
      slaResponseTime: 6,
      address: "45, MIDC, Nagpur",
    },
    {
      name: "SafeGuard Fire Systems",
      contactPerson: "Deepak Gupta",
      email: "deepak@safeguard.in",
      phone: "+91-9112233445",
      category: "Fire Safety",
      rating: 4.8,
      onTimeDelivery: 96,
      status: "active",
      contractStart: new Date("2022-04-01"),
      contractEnd: new Date("2024-03-31"),
      slaResponseTime: 2,
      address: "78, Ring Road, Hyderabad",
    },
    {
      name: "LiftMaster Elevators",
      contactPerson: "Ramesh Pillai",
      email: "ramesh@liftmaster.in",
      phone: "+91-9443322110",
      category: "Elevator",
      rating: 3.9,
      onTimeDelivery: 82,
  ...
  const workOrders = await WorkOrder.insertMany([
    {
      ...
      description: "Monthly filter replacement and belt inspection",
      auditLog: [
        {
          action: "created",
    ...
    },
    {
      ...
      title: "Elevator-01 Quarterly Service",
      type: "preventive",
      priority: "high",
      status: "in_progress",
      ...
      description: "Q3 scheduled maintenance",
    ...
    },
    {
      ...
      title: "Generator DG-01 Oil Change",
      type: "corrective",
      priority: "high",
      status: "on_hold",
      ...
      description: "Engine oil change and filter service",
      auditLog: [
        {
          action: "created",
    ...
    },
    {
      ...
      description: "Annual statutory fire pump test",
    ...
    },
    {
      ...
      description: "Adjust NVR-01 camera angles after renovation",
      auditLog: [
        {
          action: "created",
          performedBy: "Rajesh Kumar",
  ...
  const incidents = await Incident.insertMany([
    {
      ...
      category: "Plumbing",
      description: "Water dripping from cooling unit",
      reportedBy: "Suresh Babu",
      timeline: [
        {
          action: "reported",
          performedBy: "Suresh Babu",
    ...
    },
    {
      ...
      severity: "critical",
      status: "resolved",
      location: "Building B - Wing B",
      category: "Electrical",
      description: "Frequent power trips affecting workstations",
    ...
    },
    {
      ...
      category: "Elevator",
      description: "Elevator stalled between G and 1st floor",
      reportedBy: "Suresh Babu",
  ...
  const inventory = await Inventory.insertMany([
    {
      ...
      supplierName: "TechCool HVAC Solutions",
    },
    {
      code: "LUB-5L-001",
      ...
      supplierName: "ElectroPro Services",
    },
    {
      code: "MCB-32A-SP",
    ...
    },
    {
      ...
      supplierName: "SafeGuard Fire Systems",
    },
    {
      code: "ELV-CBL-01",
      name: "Elevator Cable Wire",
      ...
      supplierName: "LiftMaster Elevators",
    },
    {
      code: "LED-4FT-001",
